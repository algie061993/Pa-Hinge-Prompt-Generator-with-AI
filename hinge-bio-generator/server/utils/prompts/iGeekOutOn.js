const iGeekOutOn = {
  funny: [
    "comic book lore that explains everything (to me)",
    "the intersection of music and tech — strangely satisfying",
    "deep dives into niche documentaries — ask me my hot take",
  ],
  romantic: [
    "I melt over thoughtful {i1 about geek.",
  ...
  quirky: [
    "I collect odd stories about {i1 and giggle about geek.",
  ...
  intellectual: [
    "I love late chats about {i1 and coffee about geek.",
