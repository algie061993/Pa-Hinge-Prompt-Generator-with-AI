const imWeirdlyAttractedTo = {
  ...
  romantic: [
    "I melt over thoughtful {i1} about attracted.",
  ...
  quirky: [
    "I collect odd stories about {i1} and giggle about attracted.",
  ...
  intellectual: [
    "I love late chats about {i1} and coffee about attracted.",
