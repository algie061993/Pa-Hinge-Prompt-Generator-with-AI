const wereTheSameTypeOfWeirdIf = {
  "funny": [
    "Plot twist: Making terrible we're the same type of weird if decisions and somehow making them work",
  ...
  "serious": [
    "What I've learned: How we're the same type of weird if shaped my character and values",
