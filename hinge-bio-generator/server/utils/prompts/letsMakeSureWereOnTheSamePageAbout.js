const letsMakeSureWereOnTheSamePageAbout = {
  "funny": [
    "Plot twist: Making terrible let's make sure we're on the same page about decisions and somehow making them work",
  ...
  "serious": [
    "What I've learned: How let's make sure we're on the same page about shaped my character and values",
