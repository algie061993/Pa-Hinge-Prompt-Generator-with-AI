const letsMakeSureWereOnTheSamePageAbout = {
  "funny": [
    "Making terrible let's make sure we're on the same page about decisions and somehow making them work",
  ...
  "serious": [
    "How let's make sure we're on the same page about shaped my character and values",
