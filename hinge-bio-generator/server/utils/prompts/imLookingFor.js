const imLookingFor = {
  funny: [
    "someone who makes weekends feel like mini-adventures",
    "a co-conspirator for bad movie nights and good conversations",
    "someone who can talk deeply and also laugh at dumb jokes",
  ],
  romantic: [
    "I melt over thoughtful {i1} about looking.",
  ...
  quirky: [
    "I collect odd stories about {i1} and giggle about looking.",
  ...
  intellectual: [
    "I love late chats about {i1} and coffee about looking.",
