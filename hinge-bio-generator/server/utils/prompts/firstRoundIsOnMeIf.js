const firstRoundIsOnMeIf = {
  "funny": [
    "Plot twist: Making terrible first round is on me if decisions and somehow making them work",
  ...
  "serious": [
    "What I've learned: How first round is on me if shaped my character and values",
