const greenFlagsILookOutFor = {
  funny: [
    "kindness to strangers — obvious green flag",
    "consistent follow-through on small things",
    "emotional availability and curiosity",
  ],
  romantic: [
    "I melt over thoughtful {i1} about ilook.",
  ...
  quirky: [
    "I collect odd stories about {i1} and giggle about ilook.",
  ...
  intellectual: [
    "I love late chats about {i1} and coffee about ilook.",
