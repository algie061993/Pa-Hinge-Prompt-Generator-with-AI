const iUnwindBy = {
  funny: [
    "reading a book and making tea — simple reset",
    "a quick run and a ridiculous podcast — instant mood lift",
    "cooking something new and pretending I'm a chef",
  ],
  romantic: [
    "I melt over thoughtful {i1 about unwind.",
  ...
  quirky: [
    "I collect odd stories about {i1 and giggle about unwind.",
  ...
  intellectual: [
    "I love late chats about {i1 and coffee about unwind.",
