const whenINeedAdviceIGoTo = {
  "funny": [
    "Plot twist: Making terrible when i need advice, i go to decisions and somehow making them work",
  ...
  "serious": [
    "What I've learned: How when i need advice, i go to shaped my character and values",
...
module.exports = whenINeedAdviceIGoTo;
