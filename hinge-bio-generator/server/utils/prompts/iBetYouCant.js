const iBetYouCant = {
  funny: [
    "go a whole day without checking your phone — bet you can't",
    "try my signature snack and tell me it's not addictive",
    "come up with a better dad joke than mine — challenger mode",
  ],
  romantic: [
    "I melt over thoughtful {i1} about cant.",
  ...
  quirky: [
    "I collect odd stories about {i1} and giggle about cant.",
  ...
  intellectual: [
    "I love late chats about {i1} and coffee about cant.",
