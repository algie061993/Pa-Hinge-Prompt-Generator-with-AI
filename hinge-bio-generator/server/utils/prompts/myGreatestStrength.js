const myGreatestStrength = {
  funny: [
    "making people laugh when they need it most",
    "being persistently curious about everything",
    "staying calm during chaotic group projects",
  ],
  romantic: [
    "I melt over thoughtful {i1 about strength.",
  ...
  quirky: [
    "I collect odd stories about {i1 and giggle about strength.",
  ...
  intellectual: [
    "I love late chats about {i1 and coffee about strength.",
