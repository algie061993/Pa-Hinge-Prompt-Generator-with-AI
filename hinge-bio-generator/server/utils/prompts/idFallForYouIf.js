const idFallForYouIf = {
  funny: [
    "you surprise me with thoughtful little things",
    "you laugh at the weirdest jokes I tell",
    "you know when to listen and when to make me smile",
  ],
  romantic: [
    "I melt over thoughtful {i1} about fall.",
  ...
  quirky: [
    "I collect odd stories about {i1} and giggle about fall.",
  ...
  intellectual: [
    "I love late chats about {i1} and coffee about fall.",
