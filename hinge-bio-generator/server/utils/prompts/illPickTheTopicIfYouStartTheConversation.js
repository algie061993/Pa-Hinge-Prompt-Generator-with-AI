const illPickTheTopicIfYouStartTheConversation = {
  "funny": [
    "Plot twist: Making terrible i'll pick the topic if you start the conversation decisions and somehow making them work",
  ...
  "serious": [
    "What I've learned: How i'll pick the topic if you start the conversation shaped my character and values",
