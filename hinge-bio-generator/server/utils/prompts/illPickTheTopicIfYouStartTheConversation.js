const illPickTheTopicIfYouStartTheConversation = {
  ...
  romantic: [
    "I melt over thoughtful {i1} about conversation.",
  ...
  quirky: [
    "I collect odd stories about {i1} and giggle about conversation.",
  ...
  intellectual: [
    "I love late chats about {i1} and coffee about conversation.",
