const youShouldLeaveACommentIf = {
  "funny": [
    "Plot twist: Making terrible you should leave a comment if decisions and somehow making them work",
  ...
  "serious": [
    "What I've learned: How you should leave a comment if shaped my character and values",
